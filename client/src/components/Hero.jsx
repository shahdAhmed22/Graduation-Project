...
const Hero = () => {
    ...
    return (
        <div className='flex flex-col items-start justify-center px-6 md:px-16 lg:px-24 xl:px-32 text-white bg-[url("/src/assets/pexels-pixabay-258154.jpg")] bg-no-repeat bg-cover bg-center h-screen'>
